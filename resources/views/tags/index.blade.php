...
@section('body')
    ...
    <div>
        <a href="create.php" class="btn btn-primary" style="margin-top: 10px; font-size: larger; font-weight: bold">Add</a>
        ...
        <table class="table">
            ...
            @foreach($tags as $tagsC)
                <tr>
                    ...
                    <td>
                        <a href="update.php?id={{$tagsC->id}}" class="btn btn-success">Edit</a>
                        <a href="delete.php?id={{$tagsC->id}}" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            @endforeach
        </table>
